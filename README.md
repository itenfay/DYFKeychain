...
如果此项目能帮助到你，就请你给[一颗星](https://github.com/dgynfi/DYFKeychain)。谢谢！
...
pod 'DYFKeychain', '~> 1.0.1'
```

或者从 [Keychain](https://github.com/dgynfi/DYFKeychain/tree/master/Keychain) 目录添加文件。
